...
questions:
  - q: How do we know the command to worship is not driven by any need on Allah’s part?
    ...
    answer: 0
    why: The denial of need is explicit and placed right where the thought would arise; the Self-Sufficient takes nothing from worship — its fruit returns to the worshipper.
