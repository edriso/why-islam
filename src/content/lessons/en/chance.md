...
If it is said: "long ages work miracles" — the answer is that time alone favors nothing. Time only works when something exists to *keep* the successful attempts and build on them. And that is exactly where the next point lands.
...
questions:
  ...
  - q: What do Muslims agree on regarding evolution, and what do they differ on?
    ...
    options:
      - Agreed — Adam’s special creation with no parents; differed — whether revelation can be reconciled with evolution outside Adam
