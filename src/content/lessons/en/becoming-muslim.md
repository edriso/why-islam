...
- The first half says: nothing deserves worship but Allah alone — the summary of the units "Does the universe have a Creator?" and "Who is Allah?".
- The second half says: the man whose evidence you have examined is a messenger from Allah — the summary of the Muhammad ﷺ and Qur'an units.
...
note: 'At the hadith’s end the Prophet ﷺ told ʿUmar: “That was Jibril — he came to teach you your religion.”'
```

Six articles — and you have walked past the evidence for most of them in this guide: Allah (the opening units), His messengers and books (the messengers and why-Islam units), the Last Day (the "why did He create us?" and "why suffering?" lessons). The angels and the decree come to you from the same source whose truthfulness the argument established — and that is the difference between blind assent and a trust that built its foundation first, then relied on the proven source for what lies beyond sight.
...
note: 'ʿAmr feared his past could not be forgiven — and the condition he came to bargain for was already granted to everyone who enters.'
```
