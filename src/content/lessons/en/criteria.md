...
> **The one idea:** whoever starts comparing before fixing the scale will always crown the religion of their upbringing. So the first question is not “which religion?” but “by what standard?” — and then the standard gets applied to everyone without favoritism, with Islam first onto the scale.
...
questions:
  - q: Why fix the criteria before comparing religions?
    options:
      - Because comparison without a fixed standard usually ends with the religion of one’s upbringing winning — familiarity, not truth
