...
note: 'الدين الموصى به هنا هو أصل الدين المشترك: التوحيد. قال ابن كثير: القدرُ المشترك بينهم هو عبادة الله وحده لا شريك له، وإن اختلفت شرائعُهم ومناهجُهم، واستشهد بقوله تعالى في المائدة (٤٨). أمّا تفاصيل الشرائع، كصفة الصلاة وما يحلّ ويحرم، فقد اختلفت من رسالةٍ إلى رسالة بحسب حال كلّ أمّة. أما تفاصيل الشرائع، كصفة الصلاة وما يحلّ ويحرم، فقد اختلفت من رسالةٍ إلى رسالة بحسب حال كل أمة، كما تقرره سورة المائدة (5:48).'
```
