...
note: 'لم تُترك أمةٌ بلا نذير. والطاغوت: كل ما عُبد من دون الله. فدعوى الإسلام أنّ التوحيد ليس اختراعًا عربيًا من القرن السابع، بل الأصل الذي بُلّغته كل أمة.'
```
...
note: 'الدين الموصى به هنا عند المفسرين — كالطبري وابن كثير والسعدي — هو أصل الدين المشترك: التوحيد. أما تفاصيل الشرائع، كصفة الصلاة وما يحلّ ويحرم، فقد اختلفت من رسالةٍ إلى رسالة بحسب حال كل أمة، كما تقرره سورة المائدة (5:48).'
```
...
```doubt
claim: كل دينٍ يدّعي أنه الأصل وأنّ غيره هو المنحرف عنه. فدعوى الإسلام هذه واحدة من دعاوى كثيرة متشابهة — لماذا نصدّقها هي بالذات؟
answer: |-
