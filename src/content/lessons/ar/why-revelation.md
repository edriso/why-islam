...
highlight:
  - وما كنا معذبين
  - نبعث رسولا
note: 'من عدله سبحانه ألّا يعذّب أحدًا إلا بعد قيام الحجة عليه ببعث رسول — هذا معنى الآية عند الطبري وابن كثير. فالحساب فرعُ البلاغ.'
```
...
```note
لم يثبت هذا الدرس أنّ رسالةً بعينها صادقة — أثبت الحاجةَ إليها فقط، وأنّ العقل نفسه يطلبها. فأيُّ الرسالات صدق؟ ذلك سؤال الوحدات الآتية، وستُوزن فيه الدعاوى بميزانٍ معلَن يُطبَّق على الإسلام نفسه قبل غيره.
```
