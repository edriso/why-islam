...
- **الزكاة:** جزءٌ يسير (رُبع العُشر) من المال الذي حال عليه العامُ فائضًا عن حاجتك، يذهب إلى الفقراء. من لا فائض عنده فلا زكاة عليه.
...
answer: |-
  ...
  والعربيةُ ليست شرطًا: الدعاء يصحّ بكل لغة، وقصار السور تُتعلَّم على مهل، ومئات الملايين من المسلمين اليوم لا يتكلمون العربية. وأمّا الكمال فلم يكن قطُّ شرطَ الدخول؛ فالشرط هو الصدق. بل إنّ الباب مصمَّمٌ للمذنبين تحديدًا: فالإسلام يمحو ما قبله كلَّه، وتبدأ الصحيفة بيضاء من اللحظة الأولى.
```
