...
ليست الإجابات المحتملة كثيرةً كما قد تظن. فالعقل — أيَّ عقلٍ، في أيّ عصر — لا يتصوّر إلا ثلاثة احتمالات: أن يكون الشيء وُجد من لا شيء، أو أوجد نفسَه، أو أوجده غيرُه. هذه قسمةٌ حاصرة: ليست آراءَ مدارس تُضاف إليها آراء، بل حدود الممكن المنطقيّ نفسها.
...
```ayah
ref: 52:36
note: 'الآية تغلق آخرَ المنافذ: إن لم يخلقوا أنفسهم، فهل خلقوا الكونَ الذي هم جزءٌ منه؟ لا أحد يدّعي هذا. ثم تضع الإصبع على الموضع الحقيقيّ للمشكلة: بل لا يوقنون — ليست أزمةَ دليل، بل أزمةَ يقينٍ وجدّية.'
```

لاحظ ما الذي يفعله هذا النص: لا يشتم، ولا يهدّد، ولا يطلب تسليمًا — يعرض القسمة العقلية كاملةً ويترك السامع أمامها. فلنقف نحن أيضًا أمامها، احتمالًا احتمالًا.
...
هذا الاحتمال أسوأ حالًا من الأول: لكي يخلق الشيءُ نفسَه يلزم أن يكون موجودًا قبل وجوده — موجودًا وهو بعدُ غيرُ موجود. هذا ليس أمرًا بعيد الاحتمال يحتاج إلى إحصاء، بل تناقضٌ صريح كالمربّع الدائريّ: لا يصير ممكنًا ولو أُعطي زمنًا لا نهائيًّا.

قلّ أن يتبنّى أحدٌ هذا الاحتمال بلفظه، لكنك تسمع صداه في عباراتٍ تمرّ بلا فحص، مثل «الكون أوجد نفسه بقوانينه». والقوانين وصفٌ لسلوك الموجود — لا تسبق وجودَه ولا تملك أن تُنشئه.

## فلم يبقَ إلا الثالث

إذا كانت القسمة حاصرةً وسقط قسمان، ثبت الثالث ضرورةً — لا تفضيلًا ولا ترجيحًا: لوجودك مُوجِدٌ غيرُك، ليس أنت ولا العدم.

وقد وقعت هذه الحجّة يومًا على أذنٍ تعرف قيمة الكلام. جُبير بن مُطعِم — من سادة قريش، جاء المدينةَ في شأن أسرى بدر وهو يومئذٍ على دين قومه — سمع النبيّ ﷺ يصلّي المغرب:
...
note: 'والآية هي التي قرأتَها فوق. وفي روايةٍ أخرى قال: وذلك أوّلَ ما وقر الإيمانُ في قلبي — صحيح البخاري (٤٠٢٣). وأنه كان جاء في أسارى بدر — صحيح البخاري (٣٠٥٠).'
```

تأمّل الواقعة: رجلٌ لغتُه العربية وميزانُه البلاغة، وليس بينه وبين هذا الدين يومها إلا الخصومة. لم يسمع ترغيبًا ولا ترهيبًا ولا قصّةً مؤثّرة — سمع قسمةً عقليةً محكمة، فوصف أثرَها بأن قلبه كاد يطير. ثم أسلم بعد ذلك بسنوات. الحجّة التي تقرؤها الآن هي نفسُها التي سمعها.
...
answer: |-
  الذي تصفه الفيزياء هنا ليس عدمًا. «الفراغ الكمّي» نظامٌ فيزيائيّ قائم بذاته: له طاقةٌ وحقولٌ كمّيّة وقوانينُ صارمة تحكمه، والجسيمات «تظهر» منه كما تظهر الموجة من البحر — من شيءٍ موجودٍ مفعمٍ بالإمكانات. فالسؤال يبقى بكامل قوّته: من أين جاء البحر نفسُه — الحقول والطاقة والقوانين؟
...
```rule
لكلّ موجودٍ حادثٍ ثلاثةُ احتمالاتٍ لا رابعَ لها: وُجد من غير شيء، أو أوجد نفسَه، أو أوجده غيرُه. الأول يناقض بديهيةَ أن اللاشيء لا يعطي شيئًا، والثاني يلزم منه وجود الشيء قبل وجوده، فيبقى الثالث ضرورةً: لهذا الكون — ولك — خالقٌ غيرُه.
```
...
questions:
  ...
  - q: لماذا يستحيل أن يخلق الشيءُ نفسَه؟
    ...
    answer: 0
    why: خلقُ الشيء نفسَه يعني أنه موجودٌ وغيرُ موجودٍ في آنٍ واحد — تناقضٌ منطقيّ كالمربّع الدائريّ، لا مجرّد أمرٍ بعيد الوقوع.
