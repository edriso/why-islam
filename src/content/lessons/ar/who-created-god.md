...
يقول السائل: «تقولون إن لكل شيء خالقًا، ثم تقفون عند الله. فمن خلق الله؟ وإن جاز أن يوجد شيءٌ بلا خالق، فلماذا لا يكون الكونَ نفسَه؟» — سؤالٌ وجيه الظاهر، ويستحق جوابًا يأخذه بجدّ لا تهرّبًا.
...
```doubt
claim: 'هذا تحكُّم: جعلتم لأنفسكم استثناءً مريحًا. فإن جاز إلهٌ أزليّ بلا سبب، جاز كونٌ أزليّ بلا سبب — ونوفّر الوسيط.'
answer: |-
  الفرق ليس تحكّمًا بل شهادةُ واقع: الكون الذي نعرفه ليس أزليًّا — هذا ما تقرّره فيزياؤه (بدايةٌ للزمان والمكان) وما يقتضيه استحالةُ التسلسل، كما مضى في درسه. فالذي يقترحه السائل — كونٌ أزليّ — خيارٌ جرّبه الفكر البشريّ قرونًا وأسقطه العلمُ نفسُه قبل الدين.
  ثم إنّ الموصوف بالأزلية يجب أن يناسبها وصفُه: الكونُ متغيّرٌ، أجزاؤه حادثة، يجري عليه الزمان، ينحلّ نظامُه حرارياً — وكلّ متغيّرٍ خاضعٍ للزمن ليس أوّلًا بحقّ. فالبرهان لا يقول «كلّ شيءٍ له سبب إلا استثناءً نحبّه»، بل يقول: الحادث يحتاج مُحدثًا، والمحدَثات كلُّها تنتهي بالضرورة إلى غير حادث. الخلاف إذن ليس في وجود «موجودٍ أوّل» — لا بدّ منه على كل تقدير — بل في وصفه: أهو المادة العمياء المتغيّرة، أم الحيّ القيّوم؟ ودرسا الإتقان والضبط أجابا: أثرُ القصد ظاهر في الكون، والقصد لا يكون لمادةٍ عمياء.
```
...
وهنا لطيفةٌ تستحق التأمل، وهي في صميم موضوع هذا الدليل. أخبر النبيّ ﷺ — قبل أربعة عشر قرنًا — أنّ الناس سيتسلسل بهم السؤال حتى يبلغوا هذا الموضع بعينه:
...
note: 'وفي روايةٍ لمسلمٍ زيادةُ توجيهٍ أن يقول: آمنتُ بالله. والمقصود بالانتهاء قطعُ التسلسل الوسواسيّ الذي لا يقف — لا النهيُ عن التفكير، فالقرآن كما رأيتَ يأمر بالنظر أمرًا.'
```

رجلٌ في القرن السابع، في بيئةٍ لم تعرف الجدل الفلسفيّ، يتنبّأ بأن سؤال «من خلق ربك؟» سيطرق صدور الناس طرقًا منظّمًا — ثم يصف علاجه النفسيّ قبل المعرفيّ: هذا التسلسل وسوسةٌ تدور لا سؤالُ معرفةٍ يقف عند جواب. وها هو السؤال اليوم عنوانُ أشهر اعتراضات الإلحاد المعاصر، والجوابُ العقليّ هو هو: قِف عند الأول — فليس قبله شيء.

ولاحظ إنصاف الحديث لعِلم النفس قبل نشأته: من جرّب الوسواس يعرف أنّ سلسلة «ومن خلق؟ ومن خلق؟» لا يشبعها جواب، لأنها ليست طلبَ جواب. فالتوجيه النبويّ — اقطع الدوّامة واذكر ما قام عليه البرهان — هو عين ما يقال اليوم في علاج الأفكار الاجترارية.
...
questions:
  ...
  - q: بمَ يُجاب من يقول «إن جاز إلهٌ أزليّ فليكن الكونُ نفسه أزليًّا»؟
    ...
    answer: 0
    why: لا بدّ من موجودٍ أوّل على كل تقدير؛ والمتغيّر الحادثة أجزاؤه الخاضع للزمن لا يصلح أوّلًا — فبقي أن يكون الأول قديمًا قيّومًا مباينًا للكون.
  - q: ما وجه الدلالة في حديث «حتى يقول من خلق ربك»؟
    options:
      - إخبارٌ قبل أربعة عشر قرنًا بأن الناس سيبلغون هذا السؤال بعينه، مع وصف طبيعته الوسواسية وعلاجه — وقد وقع كما أخبر
