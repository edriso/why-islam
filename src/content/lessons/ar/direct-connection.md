...
ref: 2:186
highlight: فإني قريب
note: 'تأمّل النظم: لم يقل «فقل لهم إني قريب» — جاء الجواب مباشرًا بلا أمرِ تبليغ، فكأنّ القرب تجسّد في بناء الآية نفسه. ولاحظ الجواب: قريبٌ، أجيب دعوة الداعي إذا دعانِ — شرطُه الوحيد أن تدعوَه أنت.'
```
...
questions:
  - q: ما اللطيفة التي وقف عندها الدرس في آية القرب (البقرة 186)؟
    ...
    answer: 0
    why: آيات الأحكام حولها تجري على نسق «يسألونك... قل»، وهنا سقطت الواسطة اللفظية نفسها في آية القرب — نظمٌ يطابق معناه.
  ...
  - q: لماذا لا يقدّم هذا الدليل «حلاوة الإيمان» برهانًا على صدق الإسلام؟
    ...
    answer: 0
    why: المنهج صريح — لا يقال «صدِّق لأن المؤمنين سعداء»، بل «قام الدليل، وهذا ما وراء الباب»؛ والتجارب الروحية عند سائر الأديان هي نفسها سببُ هذا الاحتياط المنهجي.
```
