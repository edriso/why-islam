...
```tip
اجمع الدرسين الأوّلَين: لا سوابقَ كذبٍ في أربعين سنة، ولا عائدَ في ثلاثٍ وعشرين. فرضيّة «الكاذب» تحتاج كاذبًا بلا تاريخٍ في الكذب وبلا ثمرةٍ منه — أيّ كاذبٍ هذا؟
```
