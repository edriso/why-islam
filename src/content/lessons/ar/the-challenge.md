...
ثم استقرّ التحدّي عند أدنى حدٍّ يُتصوَّر — سورةٌ واحدة (يونس 38، ثم في المدينة):

```ayah
ref: 2:23
highlight: فأتوا بسورة من مثله
note: 'الخطاب هنا لكلّ مرتابٍ إلى يوم القيامة، لا لقريشٍ وحدها. وأقصر سور القرآن ثلاثُ آياتٍ في نحو عشر كلمات — هذا هو الحدّ الأدنى المطلوب.'
```
...
answer: |-
  ...
  وإن أردت الفحص المباشر فبابه مفتوح — تعلُّمُ العربيّة — وقد دخله قبلك كثيرون.
```
