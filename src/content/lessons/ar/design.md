...
خذ معرض سورة الغاشية: أربعة معروضات أمام مسافر الصحراء الذي سمع الآيات أولَ مرة — مركوبُه، وما فوقه، وما حوله، وما تحته:
...
```ayah
ref: 88:19
note: 'جبالٌ منصوبة يراها المسافر ثوابتَ في الأفق يهتدي بها، وترسو الأرض من حوله عليها — بالمعنى الذي يشهده كلُّ ناظر، من غير دعوى علمية مُقحَمة.'
```
...
note: 'التفاوت: الخلل وعدم التناسب. والفطور: الشقوق. والآية لا تقول صدِّق — تقول افحص: أرجِع البصر بنفسك وفتِّش عن الخلل.'
```
...
```doubt
claim: الضبط الدقيق لا يستلزم مصمِّمًا. فلعلّ هناك عددًا هائلًا من الأكوان بثوابتَ متفاوتة، ونحن — بحكم الضرورة — في الكون الذي سمحت ثوابته بوجود من يتساءل. لا مفاجأة إذن ولا حاجة إلى قصد.
answer: |-
  ثلاث ملاحظات، بلا تهويل. الأولى: الأكوان الأخرى غيرُ قابلة للرصد من حيث المبدأ — لا تجربة ولا مشاهدة يمكن أن تبلغها بحكم تعريفها — فالفرضية تقف خارج المنهج التجريبيّ الذي يُحتجّ به عادةً على أهل الإيمان، ويقرّ بهذا الإشكال فيزيائيون من داخل الحقل نفسه.
  الثانية: هي تكثيرٌ هائل للكائنات بلا شاهد، لغرضٍ واحد هو تجنّب فاعلٍ واحد. ميزان الاقتصاد في التفسير — الذي يُشهَر عادةً في وجه الإيمان — ينقلب هنا على صاحبه.
