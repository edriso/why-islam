...
note: 'العُسُب: جريد النخل. واللِّخاف: صفائح الحجارة الرقيقة. لاحظ المنهج: مقابلة المكتوب على المحفوظ في الصدور — القناتان تفحص إحداهما الأخرى منذ اللحظة الأولى.'
```
