...
note: 'جاء قبلها في الآية نفسها أنّ العذاب يصيب الله به من يشاء، أمّا الرحمة فذكر سعتها مطلقةً: لا شيء يخرج عن مداها. فالعذاب له أهله وأسبابه، والرحمة هي التي وسعت كلَّ شيء.'
```
...
تأمّل اختيار المقياس: لم يقُل أرحم من ملِكٍ بضيفه ولا من صديقٍ بصديقه، بل جعل الحدَّ الأدنى رحمةَ أمٍّ ثكلى وجدت طفلًا تضمّه. رحمةُ الله بعبده فوق هذا، لا مثله.
...
note: 'وفي رواية مسلم (٢٧٥١): سبقت رحمتي غضبي. فالرحمة عنده هي الأصل السابق الغالب، والغضب طارئٌ له أسبابه، عكس ما يتصوّره من ظنّ الدين تهديدًا دائمًا معلَّقًا فوق الرؤوس.'
```

## بابٌ لا يُغلَق ما دمتَ حيًّا

فماذا عمّن أفسد وأذنب حتى ظنّ أنه لا يستحقّ إلا الطرد؟ هذه أرجى آيةٍ في كتاب الله، واقرأ لمن وُجّهت:
...
```doubt
claim: كتب الإسلام نفسها مليئة بالنار والوعيد والغضب. إلهٌ يهدّد من يخالفه بعذابٍ أليم لا يستحقّ اسم الرحيم، فهذا ترهيبٌ لا رحمة.
answer: |-
  ...
  وثاني الجواب في النسبة بين الأمرين، وقد قرأتَها في هذا الدرس بنصوصها: الرحمة قاعدةٌ مكتوبةٌ سابقةٌ غالبة، والغضب طارئٌ له أسبابه، والباب مفتوحٌ ما دام العبد حيًّا حتى لمن أسرف عمرَه كلَّه. فالعذاب في تصوير القرآن ليس مزاجَ إلهٍ حادِّ الطبع، بل عاقبةَ من رأى الباب مفتوحًا طولَ عمره وأصرّ على ألّا يدخله. ومن خاف النار حقًّا فبابه هو الآية التي قرأ: لا تقنطوا.
```
